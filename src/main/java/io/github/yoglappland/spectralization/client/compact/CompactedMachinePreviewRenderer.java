...
public final class CompactedMachinePreviewRenderer {
    ...
    public static void render(
        ...
        if (blocks.isEmpty() && ioPorts.isEmpty() && forcedVolume == null) {
            return;
        }

        PreviewBounds bounds = PreviewBounds.of(blocks, ioPorts, forcedVolume);
    ...
    private CompactedMachinePreviewRenderer() {
    }
}

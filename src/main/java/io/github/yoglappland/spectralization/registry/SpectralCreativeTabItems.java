...
public final class SpectralCreativeTabItems {
    ...
    public static void accept(CreativeModeTab.Output output) {
        ...
        output.accept(Spectralization.GRATING_MASK.get());
        output.accept(Spectralization.WAVEGUIDE_MASK.get());
        output.accept(Spectralization.CIRCUIT_MASK.get());
        output.accept(Spectralization.FIBER_MOLD.get());
        output.accept(Spectralization.SINGLE_MODE_FIBER_MOLD.get());
        output.accept(Spectralization.PLATE_MOLD.get());
        ...
        output.accept(Spectralization.FIBER_DRAWING_MACHINE_ITEM.get());
        ...
        output.accept(Spectralization.STABLE_HOLOGRAPHIC_STORAGE_SHELL_ITEM.get());

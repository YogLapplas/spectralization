...
public final class ClientMicrolizerOverlayCache {
    private static final Comparator<MicrolizerOverlayPayload.Segment> SEGMENT_ORDER = Comparator
            .comparingInt((MicrolizerOverlayPayload.Segment segment) -> segment.from().getX())
    ...
    private static List<MicrolizerOverlayPayload.Segment> activeSegments = List.of();
    private static Object lastLevel;

    public static void accept(MicrolizerOverlayPayload payload) {
    ...
    public static Collection<MicrolizerOverlayPayload.Segment> activeSegments() {
        Minecraft minecraft = Minecraft.getInstance();
        if (minecraft.level == null) {
            clear();
            return List.of();
    ...
    private ClientMicrolizerOverlayCache() {
    }
}

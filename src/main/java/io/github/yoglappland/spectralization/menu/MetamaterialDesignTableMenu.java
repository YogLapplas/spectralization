...
public class MetamaterialDesignTableMenu extends AbstractContainerMenu {
    ...
    public static final int X_SLOT_X = MetamaterialDesignTableLayout.ITEM_X_BUDGET_X;
    public static final int X_SLOT_Y = MetamaterialDesignTableLayout.ITEM_X_BUDGET_Y;
    public static final int Y_SLOT_X = MetamaterialDesignTableLayout.ITEM_Y_BUDGET_X;
    public static final int Y_SLOT_Y = MetamaterialDesignTableLayout.ITEM_Y_BUDGET_Y;
    public static final int Z_SLOT_X = MetamaterialDesignTableLayout.ITEM_Z_BUDGET_X;
    public static final int Z_SLOT_Y = MetamaterialDesignTableLayout.ITEM_Z_BUDGET_Y;
    public static final int RIGHT_TOP_SLOT_X = MetamaterialDesignTableLayout.ITEM_RIGHT_TOP_X;
    public static final int RIGHT_TOP_SLOT_Y = MetamaterialDesignTableLayout.ITEM_RIGHT_TOP_Y;
    public static final int RIGHT_MIDDLE_SLOT_X = MetamaterialDesignTableLayout.ITEM_RIGHT_MIDDLE_X;
    public static final int RIGHT_MIDDLE_SLOT_Y = MetamaterialDesignTableLayout.ITEM_RIGHT_MIDDLE_Y;
    public static final int RIGHT_BOTTOM_SLOT_X = MetamaterialDesignTableLayout.ITEM_RIGHT_BOTTOM_X;
    public static final int RIGHT_BOTTOM_SLOT_Y = MetamaterialDesignTableLayout.ITEM_RIGHT_BOTTOM_Y;
    public static final int OUTPUT_SLOT_X = MetamaterialDesignTableLayout.ITEM_OUTPUT_X;
    public static final int OUTPUT_SLOT_Y = MetamaterialDesignTableLayout.ITEM_OUTPUT_Y;
    public static final int INVENTORY_X = MetamaterialDesignTableLayout.PLAYER_INVENTORY_ITEM_X;
    public static final int INVENTORY_Y = MetamaterialDesignTableLayout.PLAYER_INVENTORY_ITEM_Y;

...
public final class MicrolizerAnimationPublisher {
    ...
    public static void publishStart(ServerLevel level, BlockPos corePos, BlockPos min, BlockPos max) {
        ...
        MicrolizerAnimationPayload payload = new MicrolizerAnimationPayload(
                corePos,
                min,
                max,
                MicrolizerAnimationPayload.DEFAULT_DURATION_TICKS,
                projectedBlocks
        );
    ...
    private MicrolizerAnimationPublisher() {
    }
}
